...
:name: draft-gold-acvp-sub-kas-ifc-1.0
...
:role: editor
:docfile: draft-gold-acvp-sub-kas-ifc.adoc
...
// include::kas-ifc/sections/03-supported.adoc[]
include::kas-ifc/sections/04-testtypes.adoc[]
include::common/common-sections/05-capabilities-description.adoc[]
include::common/common-sections/051-prerequisites.adoc[]
include::kas-ifc/sections/05-capabilities.adoc[]
include::common/common-sections/06-test-vector-intro.adoc[]
include::kas-ifc/sections/06-test-vectors.adoc[]
include::kas-ifc/sections/07-responses.adoc[]
...
include::kas-ifc/sections/98-references.adoc[]
// include::kas-ifc/sections/97-examples.adoc[]
