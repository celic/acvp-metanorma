...
:name: draft-gold-acvp-sub-kas-ffc-1.0
:abbrev: ACVP KAS FFC
...
include::kas-ffc/sections/03-supported.adoc[]
include::kas-ffc/sections/04-testtypes.adoc[]
include::common/common-sections/05-capabilities-description.adoc[]
include::common/common-sections/051-prerequisites.adoc[]
include::kas-ffc/sections/05-capabilities.adoc[]
include::common/common-sections/06-test-vector-intro.adoc[]
include::kas-ffc/sections/06-test-vectors.adoc[]
include::kas-ffc/sections/07-responses.adoc[]
...
include::kas-ffc/sections/98-references.adoc[]
